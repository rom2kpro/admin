<template>
    <div>
        <router-link 
            ...
            v-if="!customer"
        >
            <span class="fas fa-plus mr-2"></span>New Staff
        </router-link>
        <div class="card border-light shadow-sm mb-4 mt-2">
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-0 font-weight-bold">
                                    <span class="icon icon-xs icon-gray w-30"><span class="fas fa-globe-europe"></span></span>Direct
                                </td>
                                <td class="border-0">
                                    Direct
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="font-weight-bold">
                                    <span class="icon icon-xs icon-info w-30"><span class="fab fa-google"></span></span>Google Search
                                </td>
                                <td>
                                    Search / Organic
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="font-weight-bold">
                                    <span class="icon icon-xs icon-danger w-30"><span class="fab fa-youtube"></span></span> youtube.com
                                </td>
                                <td>
                                    Social
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="font-weight-bold">
                                    <span class="icon icon-xs icon-purple w-30"><span class="fab fa-yahoo"></span></span> yahoo.com
                                </td>
                                <td>
                                    Referral
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="font-weight-bold">
                                    <span class="icon icon-xs icon-info w-30"><span class="fab fa-twitter"></span></span> twitter.com
                                </td>
                                <td>
                                    Social
                                </td>
        ...
        <div class="card border-light shadow-sm">
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-centered table-nowrap mb-0 rounded" v-if="customer">
                        <thead class="thead-light">
                            <tr>
                        ...
                        <tbody>
                            <!-- Item -->
                            <tr v-for="user in users" :key="user.customer_id">
                                <td class="border-0">
                                    <a href="#" class="d-flex align-items-center">
                                        ...
                                        <div><span class="h6">{{user.customer_name}}</span></div>
                                    </a>
                                </td>
                                ...
                                <td class="border-0 d-flex align-item-center">
                        ...
                        <tbody>
                            ...
                            <tr v-for="user in users" :key="user.customer_id">
                                <td class="border-0">
                                    <a href="#" class="d-flex align-items-center">
                                        <img class="mr-2 image image-small rounded-circle" alt="Image placeholder" src="../../assets/img/flags/united-states-of-america.svg" />
                                        <div><span class="h6">{{user.admin_name}}</span></div>
                                    </a>
                                </td>
                                <!-- <td class="border-0 font-weight-bold">106</td> -->
                                <!-- <td class="border-0 text-danger">
...
export default {
    ...
    methods: {
        async fetch () {
            const auth = await AdminRepository.getAllUser(this.$route.params.path, this.$store.state.admin.access_token);
            if(!auth){
                this.$router.push('/dashboard')
            } else {
                // this.customer = false    
                if(auth.data.admins){
                    this.users = await auth.data.admins;
                } else {
                    this.users = await auth.data.customers;
                    this.customer = true;
                }
